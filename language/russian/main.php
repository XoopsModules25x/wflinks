...
define("_MD_WFL_POPULARITYLTOM","Популярные (от меньшего к большему)");
define("_MD_WFL_POPULARITYMTOL","Популярные (от большего к меньшему)");
...
define("_MD_WFL_POPULARITY","Популярные");
