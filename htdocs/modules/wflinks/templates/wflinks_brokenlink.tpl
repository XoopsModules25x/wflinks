...
<{if $brokenreport == true}>
 ...
 <div align="center">
  <h4><{$smarty.const._MD_WFL_RESOURCEREPORTED}></h4>
   <div><{$smarty.const._MD_WFL_RESOURCEREPORTED}></div><br />
   ...
   <div><b><{$smarty.const._MD_WFL_DATEREPORTED}></b> <{$broken.date}></div><br />
...
<{else}>
 <div align="left">
  ...
  <div><{$smarty.const._MD_WFL_FORSECURITY}></div><br />
  <div><{$smarty.const._MD_WFL_BEFORESUBMIT}></div><br />
  <div align="center">
   <div><b><{$smarty.const._MD_WFL_FILETITLE}></b><{$link.title}></div>
   <div><b><{$smarty.const._MD_WFL_PUBLISHER}>:</b> <{$link.publisher}></div>
   <div><b><{$lang_subdate}>:</b> <{$link.updated}></div><br />
   <form action="brokenlink.php" method="POST">
	...
	<input type="submit" name="op" value="<{$smarty.const._MD_WFL_SUBMITBROKEN}>" alt="<{$smarty.const._MD_WFL_SUBMITBROKEN}>" />
	&nbsp;<input type="button" value="<{$smarty.const._MD_WFL_CANCEL}>" alt="<{$smarty.const._MD_WFL_CANCEL}>" onclick="javascript:history.go(-1)" />
   </form>
  </div>
 </div>
<{/if}>
