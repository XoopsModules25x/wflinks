 ...
 <tr>
  ...
  <{foreach item=category from=$categories}>
   <td style="text-align: center; width:5%;">
    <a href="<{$xoops_url}>/modules/<{$module_dir}>/viewcat.php?cid=<{$category.id}>"><img src="<{$category.image}>" alt="<{$category.alttext}>" title="<{$category.alttext}>" align="top" /></a>
   </td>
...
<div class="odd" style="text-align: left; font-size: smaller;"><{$lang_thereare}></div>
 <div style="padding-bottom: 12px; padding-top: 12px; text-align: left; font-size: smaller; vertical-align: middle;">
  <img src="<{$xoops_url}>/modules/<{$module_dir}>/assets/images/icon/linkload1_small.gif" title="<{$smarty.const._MD_WFL_LEGENDTEXTNEW}>" alt="" align="middle"/>&nbsp;<{$smarty.const._MD_WFL_LEGENDTEXTNEW}><br />
  <img src="<{$xoops_url}>/modules/<{$module_dir}>/assets/images/icon/linkload2_small.gif" title="<{$smarty.const._MD_WFL_LEGENDTEXTNEWTHREE}>" alt="" align="middle"/>&nbsp;<{$smarty.const._MD_WFL_LEGENDTEXTNEWTHREE}><br />
  <img src="<{$xoops_url}>/modules/<{$module_dir}>/assets/images/icon/linkload3_small.gif" title="<{$smarty.const._MD_WFL_LEGENDTEXTTHISWEEK}>" alt="" align="middle"/>&nbsp;<{$smarty.const._MD_WFL_LEGENDTEXTTHISWEEK}><br />
  <img src="<{$xoops_url}>/modules/<{$module_dir}>/assets/images/icon/linkload4_small.gif" title="<{$smarty.const._MD_WFL_LEGENDTEXTNEWLAST}>"  alt="" align="middle"/>&nbsp;<{$smarty.const._MD_WFL_LEGENDTEXTNEWLAST}>
 </div>
<{/if}>
...
<{if $showlatest}>
    <br /><br />
	<div class="odd" style="font-size: bigger; font-weight: bold;"><{$smarty.const._MD_WFL_LATESTLIST}></div>
	<br />
	<{if $pagenav}>
    <div><{$pagenav}></div>
    <br />
