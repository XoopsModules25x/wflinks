...
<div class="odd" style="text-align: left; font-size: smaller;"><{$lang_thereare}></div>
 <div style="padding-bottom: 12px; padding-top: 12px; text-align: right; font-size: smaller; vertical-align: middle;">
  <img src="<{$xoops_url}>/modules/<{$module_dir}>/assets/images/icon/linkload1_small.gif" title="<{$smarty.const._MD_WFL_LEGENDTEXTNEW}>" alt="" align="middle"/>&nbsp;<{$smarty.const._MD_WFL_LEGENDTEXTNEW}>
  <img src="<{$xoops_url}>/modules/<{$module_dir}>/assets/images/icon/linkload2_small.gif" title="<{$smarty.const._MD_WFL_LEGENDTEXTNEWTHREE}>" alt="" align="middle"/>&nbsp;<{$smarty.const._MD_WFL_LEGENDTEXTNEWTHREE}>
  <img src="<{$xoops_url}>/modules/<{$module_dir}>/assets/images/icon/linkload3_small.gif" title="<{$smarty.const._MD_WFL_LEGENDTEXTTHISWEEK}>" alt="" align="middle"/>&nbsp;<{$smarty.const._MD_WFL_LEGENDTEXTTHISWEEK}>
