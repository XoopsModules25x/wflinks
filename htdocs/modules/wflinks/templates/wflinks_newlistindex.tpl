...
<table border="0" cellspacing="2" cellpadding="0" style="white-space: nowrap;">
  <tr>
    ...
    <td class="odd" style="text-align: center; white-space: nowrap;"><a href="<{$xoops_url}>/modules/<{$module_dir}>/newlist.php?newlinkshowdays=7"><{$smarty.const._MD_WFL_1WEEK}></a></td>
    <td class="odd" style="text-align: center; white-space: nowrap;"><a href="<{$xoops_url}>/modules/<{$module_dir}>/newlist.php?newlinkshowdays=14"><{$smarty.const._MD_WFL_2WEEKS}></a></td>
    <td class="odd" style="text-align: center; white-space: nowrap;"><a href="<{$xoops_url}>/modules/<{$module_dir}>/newlist.php?newlinkshowdays=30"><{$smarty.const._MD_WFL_30DAYS}></a></td>
...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
  <tr>
    <td class="even" width="230"><b><{$smarty.const._MD_WFL_DTOTALFORLAST}> <{$newlinkshowdays}> <{$smarty.const._MD_WFL_DAYS}></b></td>
    <td>&nbsp;</td>
  </tr>
</table>
...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
  <tr>
    <td class="odd" width="199"><a href="<{$xoops_url}>/modules/<{$module_dir}>/viewcat.php?selectdate=<{$dailylink.newlinkdayRaw}>"><{$dailylink.newlinkView}></a></td>
