...
<table width="100%" cellspacing="0" cellpadding="2">
  <tr>
    <td align="left"><a href="<{$xoops_url}>/modules/<{$wfllink.module_dir}>/visit.php?cid=<{$wfllink.cid}>&amp;lid=<{$wfllink.id}>" target="_blank"><{$wfllink.title}></a> <{$wfllink.icons}></td>
    <{if $wfllink.published > 0 }>
		<td align="right"><a href="<{$xoops_url}>/modules/<{$wfllink.module_dir}>/singlelink.php?cid=<{$wfllink.cid}>&amp;lid=<{$wfllink.id}>"><span class="itemTitle style4"><{$smarty.const._MD_WFL_VIEWDETAILS}></span></a></td>
	<{/if}>
  </tr>
  ...
  <tr>
    <td colspan="2"> <table width="100%" border="0" cellspacing="0" cellpadding="2">
        <tr class="even">
          <td width="65%"> <small><b><{$smarty.const._MD_WFL_SUBMITTER}>:</b> <{$wfllink.submitter}> <{if $xoops_isadmin}><{$wfllink.adminlink}> <{/if}></small></td>
          <td><div align="right"><small><b><{$lang_subdate}>:</b>&nbsp;&nbsp;<{$wfllink.updated}></small></div></td>
        </tr>
        <tr>
          <td colspan="2">&nbsp;</td>
        </tr>
