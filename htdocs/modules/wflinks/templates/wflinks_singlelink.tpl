...
<h4 class='even' style="width: 100%; color: #2F5376;"><a href="<{$xoops_url}>/modules/<{$wfllink.module_dir}>/visit.php?cid=<{$wfllink.cid}>&amp;lid=<{$wfllink.id}>" target="_blank"><{$wfllink.title}></a>&nbsp;<{$wfllink.icons}><{if $xoops_isadmin}>&nbsp;<{$wfllink.adminlink}><{/if}></h4>
...
<table width="100%" cellspacing="0" cellpadding="2">
  <tr>
    <td colspan="2"> <table width="100%" border="0" cellspacing="0" cellpadding="2">
        <tr>
          <td width="65%" valign="top">
			...
			<a href="<{$xoops_url}>/modules/<{$wfllink.module_dir}>/visit.php?cid=<{$wfllink.cid}>&amp;lid=<{$wfllink.id}>" target="_blank">
			 <img src="<{$xoops_url}>/modules/<{$wfllink.module_dir}>/assets/images/icon/links.gif" alt="" align="absmiddle" />			</a>&nbsp;
			<a href="<{$xoops_url}>/modules/<{$wfllink.module_dir}>/visit.php?cid=<{$wfllink.cid}>&amp;lid=<{$wfllink.id}>" target="_blank">
			 <{$smarty.const._MD_WFL_LINKNOW}>			</a>
			<{if $wfllink.forumid > 0}>
			 &nbsp;<a href="<{$xoops_url}><{$wfllink.forum_path}>"><img src="<{$xoops_url}>/modules/<{$wfllink.module_dir}>/assets/images/icon/forum.png" title="<{$smarty.const._MD_WFL_INFORUM}>" alt="<{$smarty.const._MD_WFL_INFORUM}>" border="0" align="absmiddle" /></a>
          ...
          <td width="35%"> <div class="outer" style="margin-left: 10px; margin-right: 10px; padding: 4px; background-color:#E6E6E6; border-color:#999999;">
              <div><small><b><{$smarty.const._MD_WFL_SUBMITTER}>:</b>&nbsp;<{$wfllink.submitter}></small></div>
              <div><small><b><{$smarty.const._MD_WFL_PUBLISHER}>:</b>&nbsp;<{$wfllink.publisher}></small></div>
              <div><small><b><{$lang_subdate}>:</b>&nbsp;<{$wfllink.updated|wordwrap:50:"\n":true}></small></div>
              <div><small><{$wfllink.hits|wordwrap:50:"\n":true}></small></div>
              <div><small><{$smarty.const._MD_WFL_COUNTRYB}>&nbsp;</small><img src="<{$wfllink.country}>" alt="&lt;{$wfllink.countryname}&gt;" title="<{$wfllink.countryname}>" align="absmiddle" /></div>
              </div>
            <br />
          <div style="margin-left: 10px; margin-right: 10px; padding: 4px;" class="outer">
          <div> <small><b><{$smarty.const._MD_WFL_RATINGC}></b>&nbsp;<img src="<{$xoops_url}>/modules/<{$wfllink.module_dir}>/assets/images/icon/<{$wfllink.rateimg}>" alt="" align="absmiddle" />&nbsp;&nbsp;(<{$wfllink.votes}>)</small></div>
          <{if $wfllink.showpagerank > 0}><br />
          <div><small><b><{$smarty.const._MD_WFL_PAGERANK}></b></small><img src="<{$xoops_url}>/modules/<{$wfllink.module_dir}>/assets/images/icon/pr<{$wfllink.pagerank}>.png" alt="&lt;{$smarty.const._MD_WFL_PAGERANKALT}&gt;&lt;{$wfllink.pagerank}&gt;" title="<{$smarty.const._MD_WFL_PAGERANKALT}><{$wfllink.pagerank}>" align="absmiddle" />&nbsp;<small>(<{$wfllink.pagerank}>/10)</small></div>
          <{/if}>          </div>
          <br />
          <{if $tagbar}>
               <div style="margin-left: 10px; margin-right: 10px; padding: 4px; font-size: smaller;" class="outer">
                    <{include file="db:tag_bar.html"}>               </div>
          <{/if}>
          <br />
          <div>&nbsp;</div> <{if $wfllink.autoscrshot == 0}> <{if $show_screenshot == true}> <{if $wfllink.screenshot_full != ''}>
              <div>
        ...
        <tr>
          <td width="65%" style="vertical-align: middle; text-align: center; padding-top: 25px; padding-bottom: 5px;">
