...
define("_AM_WFL_PERM_PERMSNOTE","<div><b>ЗАМЕТКА:</b> Имейте в виду, что даже если Вы установили правильные разрешения на просмотр, группа может не видеть статьи или блоки, если Вы также не предоставляете этим группам разрешения по доступу к модулю. Для этого перейдите <b>System admin > Groups</b>, выберите соответствующую группу и установите флажки, чтобы предоставить своим пользователям доступ.</div>");
...
define('_AM_WFL_MINDEX_PAGEINFOTXT','<ul><li>WF-links главная страница.</li><li>Вы можете легко изменить логотип, заголовок, заголовок главной страницы и нижний колонтитул в соответствии с Вашим собственным взглядом</li></ul><br />Примечание: выбранное изображение логотипа будет использоваться в WF-links.');
