...
Een nieuwe link "{LINK_NAME}" is ingezonden in de categorie "{CATEGORY_NAME}" op {X_SITENAME} en wacht op goedkeuring.

U kunt de ingezonden link bekijken via de onderstaande link (NB: deze pagina toont alle wachtende linken in alle categoriën):
