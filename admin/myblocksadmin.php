...
function list_blocks()
{
	...
	<form action='admin.php' name='blockadmin' method='post'>
		...
		<tr valign='middle'>
			...
			<th style='text-align: center;' nowrap='nowrap'>" . _AM_SIDE . "</th>
			<th style='text-align: center;'>" . _AM_WEIGHT . "</th>
			<th style='text-align: center;'>" . _AM_VISIBLEIN . "</th>
			<th style='text-align: center;'>" . _AM_BCACHETIME . "</th>
			<th style='text-align: center;'>" . _AM_ACTION . "</th>
		</tr>\n" ; 
    ...
    foreach( array_keys( $block_arr ) as $i )
    {
		...
		<tr valign='middle'>
			...
			<td class='$class' style='text-align: center;' nowrap='nowrap' width='110px'>
        ...
        echo "
		<tr>
			<td class='foot' style='text-align: center;' colspan='6'>
