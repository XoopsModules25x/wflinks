<?php
/**
 * $Id: upload.php 9694 2012-06-23 20:42:45Z beckmi $
 * Module: WF-Links
 * Version: v1.0.3
...
switch ( strtolower($op) ) {
    ...
    case "delfile":
        ...
        if ( isset( $_POST['confirm'] ) && $_POST['confirm'] == 1 ) {
            ...
            xoops_cp_header();
            xoops_confirm( array( 'op' => 'delfile', 'uploadpath' => $_POST['uploadpath'], 'linkfile' => $_POST['linkfile'], 'confirm' => 1 ), 'upload.php', _AM_WFL_LINK_DELETEFILE . "<br /><br />" . $_POST['linkfile'], _AM_WFL_BDELETE );
        } 
        break;
    ...
    default:
        ...
        $namearray = array( 1 => _AM_WFL_LINK_CATIMAGE , 2 => _AM_WFL_LINK_SCREENSHOTS, 3 => _AM_WFL_LINK_MAINIMAGEDIR );
        $listarray = array( 1 => _AM_WFL_LINK_FCATIMAGE , 2 => _AM_WFL_LINK_FSCREENSHOTS, 3 => _AM_WFL_LINK_FMAINIMAGEDIR );
        ...
        $iform = new XoopsThemeForm( _AM_WFL_LINK_FUPLOADIMAGETO . $pathlist, "op", xoops_getenv( 'PHP_SELF' ) );
