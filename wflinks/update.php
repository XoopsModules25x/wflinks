<?php
/**
 * $Id: update.php v 1.00 29 july 2004 John N Exp $
 * Module: WF-Links
 * Version: v1.0.3
...
function install_header()
{
	...
	<body>
	<br /><div style="text-align:center"><img src="./images/logo-en.gif" alt="" /><h4>WF-Links Update</h4>
<?php
} 
...
function install_footer()
{
    ...
    ?>
	<img src="images/wfl_slogo.gif" alt="WF-Projects" border="0" /></div>
	</body>
	</html>
<?php
...
if ( $action == "message" )
{
    ...
    $act_wflinks = &$modhandler -> getByDirname( "wflinks" );
    if ( $act_wflinks )
    {
